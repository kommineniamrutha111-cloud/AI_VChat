...
(In later versions, I plan to implement features that let the AI ingest visual frames or image segments from the video, so it can better understand and respond with full context about what’s happening in the video).
